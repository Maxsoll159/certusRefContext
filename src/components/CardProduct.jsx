...
export const CardProduct = ({ product }) => {
    ...
    return (
        <div>
            <div className="bg-white shadow-xl h-[600px] rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img className="rounded-t-lg p-8 w-full h-[400px]" src={image} alt="product image" />
                </a>
                <div className="px-5 pb-5">
                    ...
                    <div className="flex items-center justify-between">
                        <span className="text-3xl font-bold text-gray-900 dark:text-white">S/. {price}</span>
                        <button
